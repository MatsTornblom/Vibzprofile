        ...
        <div className="mb-8">
          <div className="relative w-32 h-32 mx-auto mb-6">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 bg-vibz-red/20 rounded-full p-2 hover:bg-pink-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {uploadingImage ? (
