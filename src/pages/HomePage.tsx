          ...
          <div className="flex items-center gap-4">
            <StandardRedButton
              onClick={() => window.location.href = 'https://love.vibz.world'}
                className="text-sm p-2" // or text-xl, text-2xl, text-sm, etc.
            >
              <ArrowLeft size={18} />
              Spread love
            </StandardRedButton>
            <h1 className="text-4xl text-vibz-textbox-text font-deaugusta text-center pt-10">Vibz World Citizenship</h1>
          </div>
          <StandardBeigeButton
